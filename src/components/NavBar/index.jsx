...
export default function NavBar() {
  return (
    <nav class="bg-white border-gray-200 dark:bg-dark-green">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <Button className={"px-4 py-2"}>Inscrever-se</Button>
          <button
        ...
        <div
          ...
          id="navbar-cta"
        >
          <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-dark-green md:dark:bg-dark-green dark:border-gray-700">
            <li>
              <Link
                class="block py-2 px-3 md:p-0 text-white bg-inherit rounded md:bg-transparent"
                aria-current="page"
                to={"/"}
              >
                Início
